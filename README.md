...
Here i would like to split project to 3 microservice, each of them accomplishes own functional:
  * "getway-service" has to filter incorrect and not authorizations and not authentications queries (using Spring Security);</sub>
